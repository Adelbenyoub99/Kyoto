...
<body>
    ...
    <div class="form-container">
        ...
        <form id="registration-form">
            ...
            <button type="submit" href="inscription.php" class="btn-formulaire" id="btn1"><a href="inscription.php">S'inscrire</a></button>
            <button type="submit" class="btn-formulaire"id="btn2">Se connecter</button>
            </div>
