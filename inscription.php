...
<body>
    ...
    <div class="form-container">
        ...
        <form id="registration-form">
            ...
            <button type="submit" class="btn-formulaire" id="btn1">S'inscrire</button>
            <button type="submit" class="btn-formulaire" id="btn2"><a href="login.php">Se connecter</a></button>
            </div>
